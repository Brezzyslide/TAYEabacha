...
export const timesheetEntries = pgTable("timesheet_entries", {
  ...
  // Smart submission timing fields for payroll compliance
  submissionTimestamp: timestamp("submission_timestamp"), // When timesheet was actually submitted
  scheduledEndTime: timestamp("scheduled_end_time"), // Original booked end time
  paymentMethod: text("payment_method").default("scheduled"), // "actual" (early submission) or "scheduled" (late submission cap)
