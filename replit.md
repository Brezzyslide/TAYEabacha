...
- June 19, 2025. Fixed NDIS budget deduction to work with price overrides - resolved issue where budget deductions only worked with separate pricing configuration by implementing fallback logic to use budget price overrides (AM=$40, PM=$60, ActiveNight=$80, Sleepover=$100) when NDIS pricing table is empty, ensuring automatic deductions work regardless of pricing configuration method
