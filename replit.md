...
- June 19, 2025. Fixed message sending API parameter order error - corrected apiRequest function call in ComposeMessageModal from (url, method, data) to (method, url, data), resolving "'/api/messages' is not a valid HTTP method" error
